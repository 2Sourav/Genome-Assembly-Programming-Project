...
// the implementation from error-free algorithm is also applicable by slightly modifying the code to handle errors.
// but that can cause time issue(not always) for this problem to pass the grader. so,here is another implementation
// which is easier to implement and also efficient
